...
class RegisterView(CreateView):
    ...
    Методы:
        - form_valid: при успешной отправке формы сохраняет пользователя, авторизует его и отправляет
        приветственное письмо.
        - send_welcome_email: отправляет письмо с подтверждением регистрации. В случае ошибок возвращает
        URL страницы ошибки.
    """
    model = User
